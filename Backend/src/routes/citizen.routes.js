...
import { citizenLogin, citizenLogout, citizenOtpVerification, citizenRegister } from "../controllers/citizen.controller.js";
...
citizenRouter.route("/verify-otp").post(citizenOtpVerification)
